...
import {border, borderRadius, color, height, lineHeight, styled, textAlign} from '@mui/system';
...
const ChatbotMenu = () => {
  ...
  const textArea = {
    ...
    "&::placeholder": {
      color:'red',
      textAlign: 'right', // Da espacio para el label flotante
    },
  }
  ...
  return (
    <div style={container}>
      ...
      <div>
        ...
        <TextField id="ia-name" placeholder='Dirección del establecimiento?' variant="outlined" slotProps={{input: {style: textField}}} />                      
        <TextField id="ia-name" placeholder='Horarios de atención?' variant="outlined" slotProps={{input: {style: textField}}} />                      
        <SaveButton>Agregar parametro</SaveButton>
      </div>
